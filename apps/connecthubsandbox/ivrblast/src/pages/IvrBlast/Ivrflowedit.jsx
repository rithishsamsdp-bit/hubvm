...
const initialInput = {
    id: "1",
    type: "IvrGatherinput",
    data: { GIIvr: "{\"v_voiceresponseName\":\"Not Selected\",\"v_voiceresponseUrl\":\"\"}", replay: "false", replayvalue: "", timeout: "", option: "", value: { 1: ["", ""] } },
    position: { x: 250, y: 25 },
};
const Ivrr = {
    id: "1",
...
const Ivrflowedit = () => {
    ...
    const { selectedIvrFlowData, selectedIvrFlow, selectedFlowdataFetch, IvrFlowCheck, IvrflowEdit } = IvrBlast();
    ...
    -
        ...
        useEffect(() => {
            setEdges(selectedIvrFlowData[0]?.i_flowOPosition);
            contexter.setNodes(selectedIvrFlowData[0]?.i_flowOData);
            const flowName = selectedIvrFlowData[0]?.i_flowName;
            form.setFieldsValue({ flow_name: flowName });
        }, [selectedIvrFlowData]);
    ...
    const handleSaveClick = async (values) => {
        // Check if the flow name is empty
    ...
    return (
        <div className='Ivr-flow-conatiner'>
            ...
            {selectedFlowdataFetch ? (
                <div className="Ivr-flow-main-loadingedit-container">
                    <Spin size="large" />
                </div>
            ) : loading ? (
                <div className="Ivr-flow-main-loadingedit-container">
                ...
                : (
                    <div className="Ivr-flow-main-container">

...
# Sync Engine
ast_engine = create_engine(AST_DB_CONNECTION_STRING, echo=False, pool_pre_ping=True, pool_recycle=3600)
ast_session_maker = sessionmaker(bind=ast_engine, expire_on_commit=False)

...
class outBoundRequest(BaseModel):
    caller_username: str = Field(..., alias="Caller-Username")
    variable_sip_h_X_Campaign_ID: str = Field(..., alias="variable_sip_h_X-Campaign-ID")
    campaignID: str
...
class ConferenceHangupRequest(BaseModel):
    conference_name: str
    participant_id: str
    account_request: str

class ConferenceHangupAllRequest(BaseModel):
    conference_name: str
    account_request: str
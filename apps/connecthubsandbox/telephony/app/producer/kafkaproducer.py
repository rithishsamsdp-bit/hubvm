...
# Use environment variables for flexibility, fallback to user's working IP
_kafka_host = os.getenv("KAFKA_HOST", "13.126.75.6")
_kafka_port = os.getenv("KAFKA_PORT", "30092")
_bootstrap_servers = f"{_kafka_host}:{_kafka_port}"

...
# WRITER (Cluster Writer Endpoint)
WRITER_DB_CONNECTION_STRING = (
    "mysql+asyncmy://admin:%23Pulse%23%242024@pulsedb-feb29.cluster-cia2xris1iid.ap-south-1.rds.amazonaws.com:3306/{db_name}"
)
# READER (Specific Reader Instance)
READER_DB_CONNECTION_STRING = (
    "mysql+asyncmy://admin:%23Pulse%23%242024@pulsedb-feb29-instance-1-ap-south-1b.cia2xris1iid.ap-south-1.rds.amazonaws.com:3306/{db_name}"
)
READER = READER_DB_CONNECTION_STRING # For backward compatibility

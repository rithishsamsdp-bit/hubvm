...
async def create_whatsapp_template(tempName : str,tempCategory : str,selectLan : str,headerType : str,headerValue : str,mediaType : str,mediaExtType : str,bodyContent : str,footerContent : str,btnType : str,btnNameVm : str,wUrl : str,btnNameCpn : str,phoneNum : str,Phone_Code : str,btn1 : str,btn2 : str,btn3 : str,s3_URL:str,database:str,accountId:str,accountNo:str):

    response=await whatsapp_template_repo.createTemplate(tempName,tempCategory,selectLan,headerType,headerValue,mediaType,mediaExtType,bodyContent,footerContent,btnType,btnNameVm,wUrl,btnNameCpn,phoneNum,Phone_Code,btn1,btn2,btn3,s3_URL,database,accountId,accountNo)

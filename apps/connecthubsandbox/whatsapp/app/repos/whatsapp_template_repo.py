...
async def createTemplate(
    ...
    Phone_Code: str, btn1: str, btn2: str, btn3: str,s3_URL:str, database: str,
    ...
    if headerType == 'None':
        ...
        btnPayload = buttontype(btnType, btnNameVm, wUrl, btnNameCpn, phoneNum, Phone_Code, btn1, btn2, btn3)
...
def get_buttons(btn1, btn2, btn3):
    return [{"type": "quick_reply", "text": btn} for btn in (btn1, btn2, btn3) if btn and btn != 'N/A']


def buttontype(btnType, btnNameVm, wUrl, btnNameCpn, phoneNum, Phone_Code, btn1, btn2, btn3):
    if btnType in ['cta', 'CTA']:
        ...
        return get_buttons(btn1, btn2, btn3)

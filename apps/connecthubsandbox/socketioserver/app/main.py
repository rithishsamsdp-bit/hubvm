...
from monitoringsocket.socketfunction import monitoring
...
# Register namespace
sio.register_namespace(monitoring("/socketadmin/monitoring"))

# Wrap FastAPI with Socket.IO
combined_asgi_app = socketio.ASGIApp(sio, app, socketio_path="/socketadmin")

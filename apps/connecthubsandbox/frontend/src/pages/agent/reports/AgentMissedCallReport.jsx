...
import "./styles/AgentMissedCallReport.css";
...
const AgentMissedCallReport = () => {
    ...
    return (
        <div className="agent_missed_call_report">
            ...
            <div className="agent_missed_call_report_container">
                <div className="agent_missed_call_report_filter_container">
                    <Input
                        type="text"
                    ...
                    />
                    <button
                        className="agent_missed_call_report_filter_clear_button"

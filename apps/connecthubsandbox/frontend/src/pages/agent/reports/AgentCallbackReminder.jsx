...
import "./styles/AgentCallbackReminder.css";
...
import { useCallbackReminder } from "../../../store/agent/reports/useCallbackReminder";
import { useAuthStore } from "../../../store/useAuthStore.js";
import Icon from "../../../constants/Icon.jsx";

const AgentCallbackReminder = () => {
    ...
    useEffect(() => {
        if (authRole === "TL") {
            ...
            navigate(`/agent-reports/agent-callback-reminder?page=${page}&per_page=${pageSize}`);
        }
...
export default AgentCallbackReminder;
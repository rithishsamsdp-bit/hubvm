...
def fetch(limit: int, offset: int, searchString: any, campaignid: str, callDateStartRange: str, callDateEndRange: str, database: str) -> dict:
    return report_repo.fetch(limit=limit, offset=offset, searchString=searchString, campaignid=campaignid, callDateStartRange=callDateStartRange, callDateEndRange=callDateEndRange, database=database)

def listCampaign(database: str) -> dict:
    return report_repo.listCampaign(database=database)
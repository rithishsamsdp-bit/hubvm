...
const TLContactbook = () => {
  ...
  useEffect(() => {
    navigate(`/tl-contactbook?page=${page}&per_page=${pageSize}`);
  ...
  const handleChange = (e) => {
    ...
    if (name === "countryCode" && !/^\d*$/.test(value) && value.length > 3)
      return; // Allow dial code digits or short ISO code
  ...
  const handleCountryChange = (_dial, countryObj) => {
    ...
    setErrors((prev) => ({
      ...prev,
      countryCode: validateField("countryCode", countryObj.code),
    }));
  };
    ...
    <div className="agent_contactbook">
          ...
          <div className="agent_contactbook_character_filter_container">
            {Array.from({ length: 26 }, (_, i) =>
              ...
              <button
                key={letter}
                className={
                  "agent_contactbook_character_filter_btn" +
                  (selectedChar === letter ? "_active" : "")
                }
                onClick={() => {
      ...
      <Modal open={open} width="720px" onClose={() => setOpen(false)}>
        <div className="agent_contactbook_modal_header_container">
          <p className="agent_contactbook_modal_header">
        ...
        {contactCreationLoading ? (
          ...
          <>
            ...
            <form
              className="agent_contactbook_modal_form"
            ...
            >
              <div className="agent_contactbook_modal_form_grid">
                ...
                <div className="agent_contactbook_modal_form_group">
                  <label className="form_label" htmlFor="countryCode">
                    Country Code
                  </label>
                  <CountryCodeDropdown
                  ...
                  />
                  {errors.countryCode && (
                    <FormInputError message={errors.countryCode} />
                  )}
                </div>
                ...
                {/* 5) Organization Name */}
                <div className="agent_contactbook_modal_form_group">
                  <label className="form_label" htmlFor="organization">
                    Organization Name
                  </label>
                  <Input
                    id="organization"
                  ...
                  />
                  {errors.organization && (
                    <FormInputError message={errors.organization} />
                  )}
                </div>
                ...
                <div className="agent_contactbook_modal_form_group agent_contactbook_modal_form_group_address">
                  ...
                  />
                  {errors.address && (
                    <FormInputError message={errors.address} />
                  )}
                </div>
              </div>
      ...
      >
        {chatLoading ? (
          ...
          <div className="agent_contactbook_modal_container">
            <div
              className="agent_contactbook_view_modal_header"
              style={{
                display: "flex",
            ...
            >
              <div
                className="agent_contactbook_right_user_info"
              ...
              >
                ...
                <div className="agent_contactbook_right_user_name">
            ...
            <div className="agent_contactbook_split_container">
              {/* Left - Messages */}
              <div
                className="agent_contactbook_conversation_message_container"
                    ...
                    <div key={date}>
                      ...
                      {items.map((item, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className={`agent_contactbook_conversation_message_row ${
                              isSelf ? "self" : "other"
                            }`}
                          >
                                  ...
                                  <div>
                                    <div className="agent_contactbook_conversation_message_call_card_title">
                                      <div className="agent_contactbook_conversation_conversation_message_call_card_1">
                                        ...
                                        {item.details?.c_disposition || "Call"}
                                      </div>

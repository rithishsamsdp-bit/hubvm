...
export default function Popover({
  ...
  return (
    ...
    >
      ...
      <div className={`pw-popover ${open ? "pw-open" : ""} ${noStyle ? "pw-no-style" : ""}`}>
        {!noStyle && <div className="pw-popover-arrow" />}
        <div className={`pw-popover-body ${noStyle ? "pw-no-padding" : ""}`} onClick={() => closeOnContentClick && setOpen(false)}>{content}</div>
      </div>
    </div>
  );
}

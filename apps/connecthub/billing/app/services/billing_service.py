...
async def get_balance_deduct_list(
    ...
    return await billing_repo.get_balance_deduct_list(
        accountEncryption,
        accountId,
        limit,
        offset,
...
async def get_dashboard(database: str):
    return await billing_repo.get_billing_dashboard(database)



async def update_config(account_id: int, request, database: str):
    return await billing_repo.update_config(account_id, request, database)
...
from controllers import auth_controller, account_controller, saml_controller, apilogs_controller
...
class _SuppressSessionStatus(logging.Filter):
    def filter(self, record: logging.LogRecord) -> bool:
        return "GET /auth/session/status" not in record.getMessage()

logging.getLogger("uvicorn.access").addFilter(_SuppressSessionStatus())
...
app.include_router(apilogs_controller.router)
# Route setup end

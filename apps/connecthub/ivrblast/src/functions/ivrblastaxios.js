...
const getDomain = () => {
    // const testing_api = 'http://10.0.0.229:3002';
    const testing_api = 'https://connecthub-ivr.pulsework360.com';
    // const production_api = 'https://connecthub.pulsework360.com:3000';
...
const ivrblastaxios = axios.create({
    baseURL: getDomain(),

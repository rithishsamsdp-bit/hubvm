...
function Dail({ id }) {
  ...
  return (
    <div className='Dail-main-container'>
      ...
      <div className='Dail-heding-container'><h2 className='Dail-heding'>Dial</h2></div>
      <hr />
      <span>
      ...
      <Handle type="source" position="right" id="1" className="queue-atten-call"  style={{marginRight: '-5px'}} isConnectable={true} 
      ...
      <Handle type="source" position="right" id="2" className="queue-hang-up" style={{marginRight: '-5px'}}/>
    </div>
  )
}

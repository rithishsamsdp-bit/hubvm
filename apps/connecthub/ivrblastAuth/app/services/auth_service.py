...
def get_by_companycode(companycode: str, database: str) -> Optional[db.Company]:
    return auth_repo.get_by_companycode(companycode.strip(), database.strip())

def get_by_username(username: str, database: str) -> Optional[db.Agents]:
    return auth_repo.get_by_username(username.strip(), database.strip())